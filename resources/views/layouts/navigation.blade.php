<nav x-data="{ open: false }" class="xl:hidden bg-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-mr-2 flex items-center xl:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-white focus:outline-none focus:bg-transparent transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden xl:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-white">
            <div class="px-4">
                <div class="ff-baloo font-bold text-base text-white">{{ Auth::user()->name }}</div>
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-responsive-nav-link class="text-white text-xs" :href="route('logout')"
