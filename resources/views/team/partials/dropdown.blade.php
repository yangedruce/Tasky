<div x-data="{ open: false }">
    ...
    <ul class="absolute z-10 origin-bottom-left w-32 -translate-x-32 focus:outline-none" x-show="open">
        <li class="bg-white border-2 border-gray-900 rounded-md w-32 p-2"><a href="#">Make admin</a></li>
        <li class="bg-white border-2 border-gray-900 rounded-md w-32 p-2"><a href="#">Make manager</a></li>
        <li class="bg-white border-2 border-gray-900 rounded-md w-32 p-2"><a href="#">Remove member</a></li>
    </ul>
</div>